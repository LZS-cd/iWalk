        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText.getText().toString().equals("")) {
                    Toast.makeText(Retrieve_password.this, "电话不能为空", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        signBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (codeText.getText().toString().equals("")) {
                    Toast.makeText(Retrieve_password.this, "验证码不能为空", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                SMSSDK.getInstance().checkSmsCodeAsyn(phoneNum, code, new SmscheckListener() {
                    ...
                    public void checkCodeSuccess(String s) {
                        ...
                        // Toast.makeText(Retrieve_password.this, s, Toast.LENGTH_SHORT).show();
                        startActivity(new Intent().setClass(Retrieve_password.this,Change_password.class));
                        finish();
                    }
