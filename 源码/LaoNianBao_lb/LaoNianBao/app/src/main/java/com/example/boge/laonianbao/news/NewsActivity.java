...
import com.example.boge.laonianbao.HealthTips.HealthWebViewActivity;
...
//        sendRequest.setOnClickListener(this);
        ...
        final Integer[] resArray = new Integer[] { R.drawable.ic_1, R.drawable.ic_2,R.drawable.ic_3 ,R.drawable.ic_4};
    ...
    private void sendRequestWithClient() {
        ...
        try {
            ...
            HttpGet httpGet = new HttpGet("http://120.25.225.163:8080/ServletTest/News");
    ...
    private void parseJSONWithJSONObject(String jsonData) {
        try {
            ...
            for (int i = 1; i <= jsonObject.length(); i++) {
                ...
                LinearLayout ll  = (LinearLayout) findViewById(R.id.zpNews);
                ...
                TextView tips = new TextView(NewsActivity.this);
                tips.setText(title);
                ...
                TextView from = new TextView(NewsActivity.this);
                Date date = new Date();
                from.setText("老年宝新闻   "+ (date.getYear() + 1900) + "年" + (date.getMonth()+1) + "月");
                ...
                View line = new View(NewsActivity.this);
